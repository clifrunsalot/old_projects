...
public class Frame1 extends JFrame {
  ...
  private void jbInit() throws Exception  {
    image1 = new ImageIcon(helloworld.Frame1.class.getResource("openFile.png"));
    image2 = new ImageIcon(helloworld.Frame1.class.getResource("closeFile.png"));
    image3 = new ImageIcon(helloworld.Frame1.class.getResource("help.png"));
    contentPane = (JPanel) this.getContentPane();
    contentPane.setLayout(borderLayout1);
    this.setSize(new Dimension(400, 300));
    this.setTitle("Simple Hello World with JBuilderX");
    statusBar.setText(" ");
